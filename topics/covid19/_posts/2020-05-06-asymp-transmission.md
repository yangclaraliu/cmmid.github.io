...
[Full pre-print](reports/Emery_Transmission from asymptomatic SARS-CoV-2.pdf), [supplementary material](reports/Emery_Transmission from asymptomatic SARS-CoV-2 - Supplementary materials.pdf), and [code used](https://github.com/thimotei/covid19_asymptomatic_trans) are all available.
